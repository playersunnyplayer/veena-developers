...
$title = "Upcoming Projects in Mumbai | Veena Developers";
$page_title = "Upcoming Projects in Mumbai | Veena Developers";
$page_keyword = "Upcoming Projects";
$page_description = "Veena Developer brings to you the best form of luxury and comfort with its upcoming projects in Mumbai. Click here to know more.";
...
<?php include_once('externalcode.php');?>    
  ...
  <body>
    ...
    <div class="page-title page-main-section" style="background-image: url(images/Careers-2.jpg);">
      <div class="container padding-bottom-top-120 text-uppercase text-center">
        <div class="main-title">
          ...
          <a href="<?=$siteurl;?>">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#"> Upcoming Projects  </a> 
        </div>
      </div>
    </div>
    <!--===== #/PAGE TITLE =====-->
   ...
   <div >
              <?
              $ProjectNum = $Project->GetProjectUpcomingNum();
              $ProjectRes = $Project->GetProjectUpcomingRes();
              if($ProjectNum > 0)
              {
                $manoj=0;
