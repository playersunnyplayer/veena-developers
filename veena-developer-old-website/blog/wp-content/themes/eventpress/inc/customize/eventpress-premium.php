		...
		?>
			<div class="premium_info">
				<ul>
					...
					<li><a class="free-pro" href="https://www.nayrathemes.com/demo/pro/eventpress/" target="_blank"><i class="dashicons dashicons-visibility"></i><?php _e( 'Free Vs Pro','eventpress' ); ?> </a></li>
					
					<li><a class="upgrade-to-pro" href="https://www.nayrathemes.com/demo/pro/eventpress/" target="_blank"><i class="dashicons dashicons-update-alt"></i><?php _e( 'Upgrade to Pro','eventpress' ); ?> </a></li>
