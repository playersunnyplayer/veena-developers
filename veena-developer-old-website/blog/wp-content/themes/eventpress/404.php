...
<section id="page-404" class="section-padding page">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="text-404">
					<h1><?php esc_html_e('4','eventpress'); ?><span><?php esc_html_e('0','eventpress'); ?></span><?php esc_html_e('4','eventpress'); ?></h1><h2><?php esc_html_e('Something Went Wrong','eventpress'); ?></h2>
