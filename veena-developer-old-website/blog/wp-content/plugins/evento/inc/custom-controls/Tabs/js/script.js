 ...
 * @author    Nayra Theme
 */
var Evento_Customize_Control_Tabs = function ( $ ) {
    'use strict';
    ...
    $( function () {
        ...
        // Hide all controls
        $( '.evento-tabs-control' ).each( function () {
            ...
            var shownCtrls = $( this ).find( '.evento-customizer-tab > input:checked' ).data( 'controls' );
            showControls( customizerSection, shownCtrls );
        } );

        $( '.evento-customizer-tab > label' ).on( 'click', function () {
            var customizerSection = $( this ).closest( '.accordion-section' );
...
Evento_Customize_Control_Tabs( jQuery );
