...
$title = "Completed Commercial Projects Mumbai- Veena Developers";
$page_title = "Completed Commercial Projects Mumbai- Veena Developers";
$page_keyword = "Commercial Projects,Nikunj Signature,Commercial Projects,V Veena Velocity,Commercial Projects Developer,Veena Symphony,Commercial Developer In Mumbai";
$page_description = "We have Completed Commercial Projects Nikunj Signature Vasai West,Veena Velocity Phase III,Veena Symphony Ghatkopar(W),Mumbai.";
    ...
    <div class="page-title page-main-section" style="background-image: url(images/Careers-2.jpg);">
      <div class="container padding-bottom-top-120 text-uppercase text-center">
        <div class="main-title">
          <h1> Commercial Completed Projects  </h1>
          <div class="line_4"></div>
    
          <a href="<?=$siteurl;?>">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#"> Commercial Completed Projects  </a> 
        </div>
      </div>
    </div>
    <!--===== #/PAGE TITLE =====-->
    <section id="about_us" class="about-us ">
      <div class="container">
        ...
        <div class="padding_t40" >
             <?php 
              $qry=mysqli_query($con,"SELECT heading_text FROM `msp_project_heading`  WHERE `project_type`='2' and heading_type='3' and heading_status='Active' order by heading_id desc limit 1;");
              ...
              if($ProjectNum > 0)
              {
                ...
                ?>
            <h2 class="projectListing_Heading">Commercial Completed Projects  </h2>
            <p class="projectListing_Para"><?=$htext?></p>
   <div >
              <?
              $qry=mysqli_query($con,"SELECT * FROM `msp_project` WHERE msp_project_type='2' and msp_status='active' and msp_project_status='1'  order by projectid desc");
              $ProjectNum = mysqli_num_rows($qry);
