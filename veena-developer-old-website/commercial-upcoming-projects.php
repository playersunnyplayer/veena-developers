...
$title = "Upcoming Commercial Projects Borivali,Andheri, Mumbai";
$page_title = "Upcoming Commercial Projects Borivali,Andheri, Mumbai";
$page_keyword = "Commercial Upcoming Projects, Commercial Projects, V Veena Developers, Commercial Projects Developer, Commercial Project In Mumbai";
$page_description = "Veena Developers - Upcoming Commercial Projects Borivali,Andheri,Mumbai";
    ...
    <div class="page-title page-main-section" style="background-image: url(images/Careers-2.jpg);">
      <div class="container padding-bottom-top-120 text-uppercase text-center">
        <div class="main-title">
          ...
          <a href="<?=$siteurl;?>">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#"> Upcoming Commercial Projects </a> 
        </div>
      </div>
    </div>
    <!--===== #/PAGE TITLE =====-->
    <section id="about_us" class="about-us ">
      <div class="container">
        ...
        <div class="padding_t40" >
             <?php 
              $qry=mysqli_query($con,"SELECT heading_text FROM `msp_project_heading`  WHERE `project_type`='2' and heading_type='2' and heading_status='Active' order by heading_id desc limit 1;");
              ...
              if($ProjectNum > 0)
              {
                ...
                ?>
            <h2 class="projectListing_Heading">Upcoming Commercial Projects</h2>
            <p class="projectListing_Para"><?=$htext?></p>
   <div >
              <?
              $qry=mysqli_query($con,"SELECT * FROM `msp_project` WHERE msp_project_type='2' and msp_status='active' and msp_project_status='2'  order by projectid desc");
              $ProjectNum = mysqli_num_rows($qry);
             // $ProjectRes = $Project->GetProjectCompletedRes();
              ...
              }else{ ?><h3 style="text-align:center">Coming Soon</h3> <br><Br><? }
              ?>
