            ...
            <div class="container">
                <div class="property-tab bottom20">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        ?>
                        <li role="presentation" class=""><a href="#Amenities" aria-controls="summary" role="tab" data-toggle="tab" aria-expanded="false">Amenitiessssssss </a></li>
                        <? } 
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="cbp-item latest rent">
                                                        <div class="image details_pro">
                                                            <img src="<?=$siteurl;?>/images/gallery_images/resize/<?=$ProjectGalleryImages2;?>" alt="<?=$ProjectGalleryalt;?>">
                                        ...
                                        <div class="tab-pane" id="tab_default_2">
                                            <div class="row" >
                                                ...
                                                <div class="col-md-3 col-sm-6 col-xs-12">
                                                    <div class="cbp-item latest rent">
                                                        <div class="image">
                                                            <iframe width="auto" height="auto" src="https://www.youtube.com/embed/<?php echo $video_id; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="cbp-item latest rent">
                                        <div class="image details_pro">
                                            ...
                                            <div class="overlay"> <a href="<?=$siteurl;?>/images/plan_images/<?=$ProjectPlanImages;?>" class="fancybox centered" data-fancybox-group="plans"> <h4> <?=$ProjectPlanTitle;?></h4> </a> </div>
                                        </div>
                                    </div>
                                </div>
                                <?
                   ...
                   <input type="hidden" name="projectname" id="projectname"  value="<?=$Web_sitename;?>">
                                            ...
                                            <div class="col-md-10">
                                                <div class="single-query">
                                                    <input type="text" class="keyword-input" placeholder="Full Name" name="name" id="name">
                                                </div>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="single-query">
                                          ...
                                          <div class="col-md-10">
                                                <div class="single-query">
                                                   <textarea class="keyword-input" rows="4" placeholder="Message" name="message" id="comment" style="height:100px;"></textarea>
                                                </div>
                                            </div>
                                            <!--<div class="col-md-10">
                                                <div class="single-query">
                            ...
                            <div class="row padding20">
                                <div class="col-md-12"> <?=$project_site_address_map;?></div>
                                <!--<div class="col-md-6">-->
                                <!--    <div class="amenities-marker">-->
                                <!--        <?=$project_site_address_contents;?>-->
                                <!--    </div>-->
                                               ...
                                               if ($ProjectCurrentStatusNum > 0)
                                               {
                                                 ...
                                                 <div class=" col-md-3 col-sm-6 col-xs-12 cbp-item latest rent">
                                                        <div class="image details_pro">
                                                            ...
                                                            <div class="overlay"> <a href="<?=$siteurl;?>/images/current_status_images/<?=$ProjectCurrentStatusImages;?>" class="fancybox centered" data-fancybox-group="gallery1"><h4>  <?=$ProjectCurrentStatusTitle;?></h4> </a> </div>
                                                        </div>
                                                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="Walkthrough">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                 <iframe width="auto" height="auto" src="https://www.youtube.com/embed/<?php echo $video_id; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
