...
<body class="hindiFont">
	<header>
		<div class="topHeader">
			<ul class="container">
				...
				<li><a href="marathi.php" class="active">Marathi</a></li>
			</ul>
		</div>
	...
	<section class="pageWrap">
		<div class="container">
			<ul class="bulletPoints">
				<li>पालघर (पश्चिम) स्टेशन जवळ 1 RK आणि 1 BHK</li>
				<li>PMAY अंतर्गत  &nbsp;<i class="fa fa-rupee"></i> २.५ लाखांची सूट </li>
				<li>MHADA लॉटरी योजना</li>
				<!--<li>RERA NO P99000021726</li>-->
			</ul>

			<section class="mainForm">
				<h2>तुम्ही उत्सुक आहात का !!</h2>
				<form action="sendmail.php" class="d-form" method="post">
					<div class="form-group">
						<label for="name">नाम:</label><span class = "error1"> *</span>
						<input type="text" class="form-control" id="name" placeholder="आपले नाव प्रविष्ट करा" name="name">
					</div>
					<div class="form-group">
						<label for="mobile">मोबाइल नंबर:</label><span class = "error1"> *</span>
						<input type="text" class="form-control" id="mobile" placeholder="आपला मोबाइल नंबर प्रविष्ट करा"
							name="mobile">
					</div>
					<!--<div class="form-group">-->
					<!--	<label for="email">ईमेल:</label>-->
					<!--	<input type="text" class="form-control" id="email" placeholder="ई-मेल प्रविष्ट करा" name="email">-->
					<!--</div>-->
					<div class="form-group">
						<label for="Intrested">रुची आहे:</label>
						<div class="radio">
							<label>
					...
					<button type="submit" name="submit" class="btn btn-default">आपला फॉर्म भरा</button>
				</form>
			</section>
		</div>
	</section>
	...
	<footer>
		<a href="tel:8970407040" class="dialBtn">डायल करा <span>@ 8970407040</span></a>
