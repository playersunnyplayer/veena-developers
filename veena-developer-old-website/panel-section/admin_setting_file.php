    ...
    <div class="row wrapper border-bottom page-heading">
      <div class="col-lg-6">
        ...
        <ol class="breadcrumb">
          ...
          <li> <a><?=$sitename;?></a> </li>
          <li class="active"> <strong> Admin Setting </strong> </li>
        </ol>
      </div>
        <div class="col-lg-6">
        ...
        <div class="col-lg-12 top20">
          <div class="widgets-container">
           <!--  <h5>Visible labels Form</h5>
            ...
            <form id="AddAdminSettingForm" enctype="multipart/form-data"  method="post" >
            <input type="hidden" name="mode" id="mode"  value="addmode">
              <div class="row">
                <div class="col-md-2">
                    <label for="firstname">First Name  </label>
                  <input class="form-control" name="firstname" id="firstname" value="<?=$sitefirstname;?>" required placeholder="first name" type="text">
                </div>
                <div class="col-md-2">
                    <label for="lastname">Last Name</label>
                  <input class="form-control" name="lastname" id="lastname" value="<?=$sitelastname;?>" required placeholder="last name" type="text">
                </div>
                <div class="col-md-2">  
                    <label for="username">Username</label>
                  <input class="form-control" name="username" id="username" value="<?=$siteusername;?>" required placeholder="username" type="text">
                </div>
                <div class="col-md-6">
                    <label for="email">Email Address</label>
                  <input class="form-control" name="email" id="email" value="<?=$siteemail;?>" placeholder="email address" type="text">
                </div>
                
              </div>
                <div class="space-msp"></div>
              <div class="row">
                <div class="col-md-3">
                    <label for="mobile">Mobile Number</label>
                  <input class="form-control" name="mobile" id="mobile" value="<?=$sitemobile;?>" placeholder="mobile" type="text">
                </div>
                <div class="col-md-3">
                    <label for="phone">Phone Number</label>
                  <input class="form-control" name="phone" id="phone" value="<?=$sitephone;?>" placeholder="phone" type="text">
                </div>
                
                <div class="col-md-6">
                    <label for="address">Address</label>
                  <input class="form-control" name="address" id="address" value="<?=$siteaddress;?>" placeholder="address" type="text">
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input class="form-control" name="name" id="name" value="<?=$sitename;?>" required placeholder="Website Name" type="text">
                </div>
                                
                <div class="col-md-6">
                    <label for="siteurl">Site url</label>
                  <input class="form-control" name="siteurl" id="siteurl" value="<?=$siteurl;?>" placeholder="website url address" type="text">
                </div>
