...
if (isset($_POST["mode"]))
{
  if($_POST["mode"]=='addproject_slider')
  {
    ...
    if ($image)
    {
        ...
        {           
            ...
            $sqlQueryAdd = "INSERT INTO `msp_project_slider` (`msp_website_id`,`msp_title`,`msp_image`,`msp_status`)VALUES ('$SessionWebsiteID', '$title','$imagename','$status')";
            $sqlRes = $ProjectSlider->dbquery($sqlQueryAdd) or die("Err : ");
            header("Location: project_slider.php?wb=$SessionWebsiteID&action=add");
            exit();
        }
    }
    else
      ...
      ?>
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <form id="ProjectSliderForm" name="ProjectSliderForm" method="post" enctype="multipart/form-data" action="<?php $PHP_SELF; ?>">
              <input name="mode" id="mode" value="addproject_slider" type="hidden">
              <div class="row">
                <div class="col-md-6">
