...
if (isset($_POST["mode"]))
{
  if($_POST["mode"]=='addproject_download')
  {
    ...
    $sqlQueryAdd = "INSERT INTO `msp_project_download` (`msp_website_id`,`msp_title`,`msp_image`,`msp_image2`,`msp_status`)VALUES ('$SessionWebsiteID', '$title','$imagename','$imagename2','$status')";
    $sqlRes = $ProjectDownload->dbquery($sqlQueryAdd) or die("Err : ");
    header("Location: project_download.php?wb=$SessionWebsiteID&action=add");
    exit();
    ...
    <div class="row wrapper border-bottom page-heading">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> <strong> Add Download  </strong> </li>
        </ol>
      </div>
    </div>
      <?php
      ...
      ?>
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <form id="ProjectDownloadForm" name="ProjectDownloadForm" method="post" enctype="multipart/form-data" action="<?php $PHP_SELF; ?>">
              <input name="mode" id="mode" value="addproject_download" type="hidden">
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                      <label for="image">PDF Upload</label>
