<div class="page-header navbar navbar-fixed-top">
  ...
  <!-- BEGIN HEADER INNER -->
    ...
    <div class="page-logo"> <a href="index.php"> <img class="logo-default" alt="logo" src="../images/sitelogo_images/<?=$SessionWebsiteLogo;?>"> </a> </div>
...
<!--  TOP NAVIGATION MENU -->
                ...
                <div class="hor-menu  hor-menu-light hidden-sm hidden-xs">
                    ...
                    <form method="GET" action="search_results.html" class="search-form search-form-expanded">
        ...
        <li class="dropdown"> <a href="#" data-toggle="dropdown" class="dropdown-toggle count-info" > <i class="fa fa-envelope"></i> <span class="badge badge-info">6</span> </a>
          ...
          <ul class="dropdown-menu dropdown-messages menuBig">
            ...
            <li>
              ...
              <div class="dropdown-messages-box"> <a class="pull-left" href="profile.html"> <img src="assets/images/teem/a7.jpg" class="img-circle" alt="image"> </a>
