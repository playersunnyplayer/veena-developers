                ...
                <div class="widgets-container">
                    ...
                    <table id="example6" class="display nowrap table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      if ($TablePageNum > 0)
                      {
                        ...
                        {
                          $TablePageID = $TablePageData["press_releasesid"];
                        ...
                        ?>
                        <tr>
                          <td><img src="../images/<?=$PageName;?>_images/<?=$TablePageImage;?>" width="100%" ></td>
                          <td><a href="../images/<?=$PageName;?>_images/pdf/<?=$TablePageImage2;?>" target="_blank" style="font-size:30px; color: #f00;" > <i class="fa fa-file-pdf-o"></i> </a></td>
