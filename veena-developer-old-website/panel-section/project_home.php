...
if (isset($_POST["mode"]))
{
    if ($_POST["mode"] == "add")
    {
        ...
        if ($PageInfoNum > 0 )
        {
            $sqlQuery = "UPDATE `$TableName` set `page_title` = '$page_title', `page_keyword` = '$page_keyword' , `page_description` = '$page_description' , `title` = '$title' , `contents` = '$contents' , `contents2` = '$contents2' , `image` = '$imagename' where websiteid= '$SessionWebsiteID'";
        ...
        {
            $add = "INSERT INTO `$TableName` (`websiteid` ,`page_title` , `page_keyword` , `page_description` , `title` , `contents`, `contents2`, `image`) VALUES ('$SessionWebsiteID','$page_title', '$page_keyword', '$page_description', '$title', '$contents', '$contents2', '$imagename')";
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <input name="old_image" id="old_image" value="<?=$image;?>" type="hidden">
                ...
                <hr>
                <div class="form-group">
                  <label for="contents2">Short Description</label>
                  <textarea class="form-control"  name="contents2" id="contents2"  placeholder="Short Description"> <?=$contents2;?></textarea>
