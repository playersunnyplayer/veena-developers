      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a><?=$sitename;?></a> </li>
            <li class="active"> <strong>Partner Form</strong> </li>
          </ol>
        </div>
      </div>
                    ...
                    <table id="example6" class="display nowrap table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th width="10%">Nature of Transaction</th>
                          <th width="10%">Category of Development</th>
                          <th width="10%">Date</th>
                        </tr>
                      </thead>
                      <tfoot>
                      ...
                      $result = mysqli_query($con,"SELECT * FROM msp_enquiry_partner ORDER BY enquiryDate DESC");
