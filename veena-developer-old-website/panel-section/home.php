...
if (isset($_POST["mode"]))
{
    if ($_POST["mode"] == "add")
    {
        ...
        if ($PageInfoNum > 0 )
        {
            $sqlQuery = "UPDATE `$TableName` set `page_title` = '$page_title', `page_keyword` = '$page_keyword' , `page_description` = '$page_description' , `title` = '$title' , `contents` = '$contents', `contents2` = '$contents2' , `image` = '$imagename'";
        ...
        {
            $add = "INSERT INTO `$TableName` (`page_title` , `page_keyword` , `page_description` , `title` , `contents`, `contents2`, `image`) VALUES ('$page_title', '$page_keyword', '$page_description', '$title', '$contents', '$contents2', '$imagename')";
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <input name="old_image" id="old_image" value="<?=$imagename;?>" type="hidden">
                ...
                <hr>
                <div class="form-group">
                  <label for="title">Disclaimer</label>
                  <div class="uniformjs">
                                      <?php
