...
if (isset($_POST["mode"]))
{
    if ($_POST["mode"] == "add")
    {
        ...
        $marques = prepare_input($_POST["marques"]);
        ...
        if ($PageInfoNum > 0 )
        {
            $sqlQuery = "UPDATE `$TableName` set `page_title` = '$page_title', `page_keyword` = '$page_keyword' , `page_description` = '$page_description' , `title` = '$title' , `contents` = '$contents' , `image` = '$imagename', `marques` = '$marques'";
        ...
        {
            $add = "INSERT INTO `$TableName` (`page_title` , `page_keyword` , `page_description` , `title` , `contents`, `image`, `marques`) VALUES ('$page_title', '$page_keyword', '$page_description', '$title', '$contents', '$imagename', '$marques')";
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <input name="old_image" id="old_image" value="<?=$imagename;?>" type="hidden">
               ...
               <!--  <div class="form-group">
                  <label for="marques">Slide Contents</label>
                  <input class="form-control"  name="marques" id="marques" value="<?=$marques;?>" placeholder="Slide Contents"  type="text">
                </div> -->
                <hr>
                <!-- <div class="row">
                <div class="col-md-6">
