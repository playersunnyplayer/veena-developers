      ...
      {   // this will check if any blank field is entered
        ...
        else
        {
          ...
          if ($width > 800)
          {
            ...
            $imagename2 = $img_title."-plan-resize-".$image_name2;
            ...
            $sqlQueryAdd = "INSERT INTO `msp_project_plan` (`msp_website_id`,`msp_title`,`msp_image`,`msp_image2`,`msp_status`)VALUES ('$SessionWebsiteID', '$title','$imagename','$imagename2','$status')";
            $sqlRes = $ProjectPlan->dbquery($sqlQueryAdd) or die("Err : ");

        }
        $i = $i + 1;
      }
    }
    header("Location: project_plan.php?wb=$SessionWebsiteID&action=add");
    exit();
    ...
    <div class="row wrapper border-bottom page-heading">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> <strong> Add Plan  </strong> </li>
        </ol>
      </div>
    </div>
      <?php
      ...
      ?>
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              <quote style="font-size: 16px;color: red;">Note: Last Inserted image will show first</quote>
              <form id="ProjectPlanForm" style="padding-top: 45px;" name="ProjectPlanForm" method="post" enctype="multipart/form-data" action="<?php $PHP_SELF; ?>">
              <input name="mode" id="mode" value="addproject_plan" type="hidden">
              <div class="row">
                <div class="col-md-6">
