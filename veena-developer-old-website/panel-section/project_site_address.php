...
$PageName = 'project_site_address';
$TableName = 'msp_project_site_address';
$HeaderTitle = 'Site Address';
if (isset($_POST["mode"]))
{
    if ($_POST["mode"] == "add")
    {
        ...
        if ($PageInfoNum > 0 )
        {
            $sqlQuery = "UPDATE `$TableName` set `page_title` = '$page_title', `page_keyword` = '$page_keyword' , `page_description` = '$page_description' , `title` = '$title' , `contents` = '$contents' , `contents2` = '$contents2' , `image` = '$imagename', `map` = '$map' where websiteid= '$SessionWebsiteID'";
        ...
        {
            $add = "INSERT INTO `$TableName` (`websiteid` ,`page_title` , `page_keyword` , `page_description` , `title` , `contents`, `contents2`, `image`, `map`) VALUES ('$SessionWebsiteID','$page_title', '$page_keyword', '$page_description', '$title', '$contents', '$contents2', '$imagename', '$map')";
            ...
            <div class="widgets-container">
              ...
              <input name="old_image" id="old_image" value="<?=$imagename;?>" type="hidden">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="map" id="map" placeholder="Google Map Code"><?=$map;?></textarea>
