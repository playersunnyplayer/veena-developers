...
include 'sessions_file_project.php';
 ...
 if (isset($_GET["mode"]))
 {
   if ($_GET["mode"] == "delete_item")
   {
    ...
    $page = $_GET["page"];
    $Query = "delete from msp_project_gallery where project_galleryid = '$item_id'";
    $ProjectGallery->dbquery($Query);
    
    header("Location: project_gallery.php?wb=$wb&action=remove");
    exit();
   }
 }
     ...
     if ($_GET["action"] == "update") {
           ...
           <div id="showpopup"></div>
             <div class="ibox-title">
               <h5>Gallery Manegments</h5>
               <div class="ibox-tools" > <a class="btn aqua btn-xs" href="#" onclick="window.location='add_project_gallery.php?wb=<?=$SessionWebsiteID;?>'" >Add New Gallery</a> </div>
             </div>
             ...
             <div class="ibox-content collapse in">
               <div class="widgets-container">
                   ...
                   <table id="example6" class="display nowrap table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                     ...
                     <?php
                     $ProjectGalleryNum = $ProjectGallery->GetProjectGalleryByWebsiteNum($SessionWebsiteID);
                     $ProjectGalleryRes = $ProjectGallery->GetProjectGalleryByWebsiteRes($SessionWebsiteID);
                     ...
                     if ($ProjectGalleryNum > 0)
                     {
                       ...
                       ?>
                       <tr>
                         <td><img src="../images/gallery_images/resize/<?=$ProjectGalleryImages2;?>" width="100%"></td>
                         <td><?=$ProjectGalleryTitle;?></td>
                         <td><?=$ProjectGalleryStatus;?></td>
                         <td class="project-actions">
                         <a class="green btn btn-outline btn-xs" href="edit_project_gallery.php?wb=<?=$SessionWebsiteID;?>&ProjectGalleryID=<?=$ProjectGalleryID;?>" data-toggle="modal" ><i class="fa fa-pencil"></i> Edit </a> 
                         <a class="red btn btn-outline btn-xs" href="#" onClick="javascript:DeleteParentImage('<?=$ProjectGalleryID;?>', 'project_gallery', '<?=$SessionWebsiteID;?>');"  ><i class="fa fa-trash-o"></i> Delete </a> </td>
                       </tr>
                       <? }
                       } ?>
