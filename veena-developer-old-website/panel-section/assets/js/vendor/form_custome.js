...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    $("#AddChangePasswordForm").validate({
     rules: {
       current_password: {
        required: true
      },
    ...
    messages: {
      ...
      confirm_password: {
        ...
        minlength: "Your confirm new password must be at least 5 characters long",
      ...
      status: "Please select status"
       ...
       submitHandler : function () {
            ...
            $.ajax({
                type : "POST",
                url : "add_form_custom.php",
                data : $('#AddChangePasswordForm').serialize(),
                success : function (response) {
                  //alert(response);
                   if (response == 1)
                    {
                      document.getElementById("AddChangePasswordForm").reset(); 
            ...
            $.ajax({
                ...
                success : function (response) {
                  ...
                  // $('#alert_message').html(response);
                   ...
                   if(!alert('Details added succesfully!')){
...
// AddCourseForm
$(document).ready(function () {
    $("#ProjectCurrentStatusForm").validate({
      rules: {
      month_year: "required",
      title: {
        required: true
