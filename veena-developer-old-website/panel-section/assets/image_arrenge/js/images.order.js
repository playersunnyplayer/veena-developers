...
function saveData(TableName, PageName)
{
	var saveString = "";
	...
	document.location.href= PageName+".php?mode=arrange&order_numbers="+saveString+"&TableName="+TableName;
...
function saveData2(TableName, PageName, parent_id)
{
	var saveString = "";
	for(var no=0;no<dragableObjectArray.length;no++)
	{
	...
	document.location.href= PageName+".php?mode=arrange&order_numbers="+saveString+"&TableName="+TableName+"&wb="+parent_id;
	//document.location.href="product_details.php?mode=arrange&order_numbers="+saveString+"&ProductID="+ProductID;
