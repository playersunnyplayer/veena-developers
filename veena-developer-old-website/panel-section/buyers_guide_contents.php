...
$PageName = 'buyers_guide_contents';
$TableName = 'msp_buyers_guide_contents';
$HeaderTitle = 'Buyers Guide Page';
if (isset($_POST["mode"]))
{
    if ($_POST["mode"] == "add")
    {
        ...
        if ($PageInfoNum > 0 )
        {
            $sqlQuery = "UPDATE `$TableName` set `page_title` = '$page_title', `page_keyword` = '$page_keyword' , `page_description` = '$page_description' , `title` = '$title' , `contents` = '$contents' ";
        ...
        {
            $add = "INSERT INTO `$TableName` (`page_title` , `page_keyword` , `page_description` , `title` , `contents`) VALUES ('$page_title', '$page_keyword', '$page_description', '$title', '$contents')";
