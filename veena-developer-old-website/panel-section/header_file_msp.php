<?
$AdminInfo = $Admin->getAdminInfo($AdminLoggedUserID);
...
<div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                ...
                <a href="index.php"> <img class="logo-default" alt="logo" src="../images/<?=$sitelogo;?>"> </a>
...
<!--  TOP NAVIGATION MENU -->
                ...
                <div class="hor-menu  hor-menu-light hidden-sm hidden-xs">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="classic-menu-dropdown active"> <a href="index.php"><i class="icon-home fa-fw"></i></a> </li>
                        <li class="classic-menu-dropdown "> <a href="index.php"> <i class="icon-user fa-fw"></i><?=$AdminLoggedUserSitename;?></a>  </li>
