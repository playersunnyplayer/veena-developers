                ...
                <div class="widgets-container">
                    ...
                    <table id="example6" class="display nowrap table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      if ($TablePageNum > 0)
                      {
                        ...
                        {
                          $TablePageID = $TablePageData["csr_galleryid"];
                          $TablePageTitle = $TablePageData["msp_title"];
                          $TablePageImage = $TablePageData["msp_image"];
                          $TablePageImage2 = $TablePageData["msp_image2"];
                          $TablePageStatus = $TablePageData["msp_status"];
                        ?>
                        <tr>
                          <td><img src="../images/<?=$PageName;?>_images/resize/<?=$TablePageImage2;?>" width="100%" data-toggle="modal" data-target="#myModal<?=$TablePageID;?>"></td>
...
while ($TablePageData = $CMS->dbfetch($TablePageRes))
    {
      ...
      $TablePageImage = $TablePageData["msp_image"];
      ?>
<div id="myModal<?=$TablePageID;?>" class="modal fade" role="dialog">
  <div class="modal-dialog">              
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="../images/<?=$PageName;?>_images/<?=$TablePageImage;?>" class="img-responsive">
      </div>
    </div>
  </div>
</div>
