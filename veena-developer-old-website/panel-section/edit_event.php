...
if (isset($_POST["mode"]))
{
  if($_POST["mode"]=='editevent')
  {
    $EventID = prepare_input($_POST["EventID"]);
    ...
    $sqlQuery = "UPDATE `msp_event` set 
                                `msp_title` = '$title' ,
                                `msp_image` = '$imagename' ,
                                `msp_image2` = '$imagename2' ,
                                `msp_status` = '$status'
                                where eventid = '$EventID'";
    $sqlRes = $Event->dbquery($sqlQuery) or die("Err : ");
    header("Location: event.php?action='update'");
    exit();
  }
}
$EventID = $_GET["EventID"];
$EventData = $Event->GetEventDetails($EventID);
$title = $EventData["msp_title"];
$image = $EventData["msp_image"];
$image2 = $EventData["msp_image2"];
$status = $EventData["msp_status"];
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="page-content" >
    <div class="row wrapper border-bottom page-heading">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> <strong> Edit Event  </strong> </li>
        </ol>
      </div>
    </div>
    ...
    <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <form id="EditEventForm" name="EditEventForm" method="post" enctype="multipart/form-data" action="<?=$_SERVER['PHP_SELF']; ?>">
              <input name="mode" id="mode" value="editevent" type="hidden">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                   <? if(!empty($image2)){ ?> <br> <img src="../images/event_images/resize/<?=$image2;?>" width="150"><? } ?>
