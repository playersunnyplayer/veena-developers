...
include 'sessions_file.php';
  $con=mysqli_connect('127.0.0.1','veena3oh_dbuser','igD*]e!vYC{y','veena3oh_demo')or die('can\'t establish connection with mysqlii servver');
      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a><?=$sitename;?></a> </li>
            <li class="active"> <strong>Quick Enquiry</strong> </li>
          </ol>
        </div>
      </div>
              ...
              <div class="ibox-content collapse in">
                <div class="widgets-container">
                    ...
                    <table id="example6" class="display nowrap table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      ...
                      $result = mysqli_query($con,"SELECT * FROM msp_enquiry_contact ORDER BY enquiryDate DESC");
