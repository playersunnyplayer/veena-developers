...
$PageName = "project_typology";
$TableName = "msp_project_typology";
$TableIDName = "typologyid";
$PageTitle = "Project Typology";
...
if (isset($_POST["mode"]))
{
  if($_POST["mode"]=='add')
  {
    ...
    $sqlQueryAdd = "INSERT INTO `$TableName` (`msp_title`,`msp_status`)VALUES ('$title','$status')";
