  ...
  if($_POST["mode"]=='addaward')
  {
    ...
    if ($image)
    {
        ...
        {   
            ...
            $sqlQueryAdd = "INSERT INTO `msp_award` (`msp_title`,`msp_image`,`msp_image2`,`msp_status`)VALUES ('$title','$imagename','$imagename2','$status')";
            $sqlRes = $Award->dbquery($sqlQueryAdd) or die("Err : ");
            header("Location: award.php?action=add");
            exit();
        }
    }
    else
    ...
    <div class="row wrapper border-bottom page-heading">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"> <strong> Add Award  </strong> </li>
        </ol>
      </div>
    </div>
      <?php
      ...
      ?>
          ...
          <div class="ibox float-e-margins">
            <div class="widgets-container">
              ...
              <form id="AwardForm" name="AwardForm" method="post" enctype="multipart/form-data" action="<?=$_SERVER['PHP_SELF']; ?>">
              <input name="mode" id="mode" value="addaward" type="hidden">
              <div class="row">
                <div class="col-md-6">
