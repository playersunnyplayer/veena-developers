...
$title = "Residential Completed 1,2,3BHK Flats in Mumbai";
$page_title = "Residential Completed 1,2,3BHK Flats in Mumbai";
$page_keyword = "Residential project, 1,2,3BHK Flats in Mumbai, Veena Laya, Sahil Villa, Veena Sarang, Veena Saraswati, Veena Sur, Veena Sagar, Residential projects in mumbai";
$page_description = "We have completed more than 10 residential 1,2,3BHK Flats, Veena Santoor 1 &amp; 2, Veena Swar, Sur and Taal, Veena Velocity Phase I, Veena Laya, Sahil Villa, Veena Sarang, Veena Saraswati, Veena Sur, Veena Sagar etc.";
    ...
    <div class="page-title page-main-section" style="background-image: url(images/Careers-2.jpg);">
      <div class="container padding-bottom-top-120 text-uppercase text-center">
        <div class="main-title">
          <h1> Residential Completed Projects  </h1>
          <div class="line_4"></div>
    
          <a href="<?=$siteurl;?>">home</a><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span><a href="#"> Residential Completed Projects  </a> 
        </div>
      </div>
    </div>
    <!--===== #/PAGE TITLE =====-->
    <section id="about_us" class="about-us ">
      <div class="container">
        ...
        <div class="padding_t40" >
             <?php 
              $qry=mysqli_query($con,"SELECT heading_text FROM `msp_project_heading`  WHERE `project_type`='1' and heading_type='3' and heading_status='Active' order by heading_id desc limit 1;");
              ...
              if($ProjectNum > 0)
              {
                ...
                ?>
            <h2 class="projectListing_Heading">Residential Completed Projects  </h2>
            <p class="projectListing_Para"><?=$htext?></p>
   <div >
              <?
              $qry=mysqli_query($con,"SELECT * FROM `msp_project` WHERE msp_project_type='1' and msp_status='Active' and msp_project_status='1' order by projectid desc");
              $ProjectNum = mysqli_num_rows($qry);
