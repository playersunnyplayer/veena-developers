<?php
/* Required settings     */
$CLOAKING['WHITE_PAGE'] = 'https://knaviaoldaksmdasd.site/';//PHP/HTML file or URL used for bots
$CLOAKING['OFFER_PAGE'] = 'https://knaviaoldaksmdasd.site/';//PHP/HTML file or URL offer used for real users
