...
if (!defined('PHPEXCEL_ROOT')) {
   define('PHPEXCEL_ROOT', ABS_PATH.DS."modules".DS."PHPExcel".DS);
   // require(PHPEXCEL_ROOT . 'PHPExcel/Autoloader.php');
	require(ABS_PATH.DS."modules".DS."PHPExcel".DS."PHPExcel".DS."Autoloader.php");
	require(ABS_PATH.DS."modules".DS."PHPExcel".DS."PHPExcel".DS."IOFactory.php");
