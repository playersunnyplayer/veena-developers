  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="checkout-section">
         <form method="post" id="checkoutAddressForm" name="checkoutAddressForm">
            <? $app->htmlBuilder->buildTag("input", array("type"=>"hidden","value"=>$id), "addressID") ?>
            ...
            <div class="row">
               ...
               <p class="checkout-section__field col-lg-6 col-12">
                  ...
                  <? $app->htmlBuilder->buildTag("input", array("type"=>"text","class"=>"rounded required","value"=>$line2), "line2") ?>
               </p>
               <p class="checkout-section__field col-12">
                  <label for="address_03">Address (Area and Street)</label>
               <? $app->htmlBuilder->buildTag("textarea", array("type"=>"text","class"=>"rounded required","rows"=>"1","cols"=>"5","value"=>$line1), "line1") ?>
               </p>

               <p class="checkout-section__field col-lg-4 col-12">
                  <label for="pincode">Pincode</label>
                <? $app->htmlBuilder->buildTag("input", array("type"=>"text","class"=>"rounded required numbers","value"=>$zipcode,"minlength"=>"6","maxlength"=>"6"), "zipcode") ?>
               </p>

               <p class="checkout-section__field col-lg-4 col-12">
                  <label for="locality">City/District/Town</label>
                  <? $app->htmlBuilder->buildTag("input", array("type"=>"text","class"=>"rounded required","value"=>$city), "city") ?>
               </p>
               <p class="checkout-section__field col-lg-4">
                  <label for="address_province_ship" id="address_province_label">State</label>
                  <? $app->htmlBuilder->buildTag("select", array("class"=>"rounded required","selected"=>$state_id, "values"=>$records1,"required"=>""), "state_id") ;?>
               </p>
               ...
               <div class="col-lg-12 mb-3 mt-2 col-12">
                  ...
                  <button type="submit" class="addEditAddress button button_primary fs__14 btn lh_36 pl-3 pr-3 font-weight-bold mr-3">Save and Deliver Here</button>
