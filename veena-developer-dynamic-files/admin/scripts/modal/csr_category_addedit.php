...
if($id!='')
{
	$obj_brand = $app->load_model("csr_category");
...
<div class="modal fade" id="modal_csr_category_addedit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content tx-14">
      <div class="modal-header">
        <h6 class="modal-title" id="exampleModalLabel2">CSR Category Form</h6>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
      </div>
      <form method="post" name="csr_category_form" id="csr_category_form"  data-parsley-validate>
          ...
          <div class="form-row">
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <? $app->htmlBuilder->buildTag("select", array("class"=>"form-control ","selected"=>$sort_id, "values"=>$app->utility->sort_order('csr_category'),"required"=>""), "sort_id") ;?>
              </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary tx-13 submit_btn csr_category_modal_submit">Submit</button>
        </div>
      </form>
    </div>
  </div>
