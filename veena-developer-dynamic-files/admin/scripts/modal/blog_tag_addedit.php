...

{
	...
	$obj_brand = $app->load_model("blog_tag");
	...
	$blog_tag_img=$app->utility->get_image_path($image,$folder,'thumb');
	...
	$log_img=$app->utility->get_image_path($img_name,$folder,'thumb');
							 ...
							 if($result[0]['image']!='' && file_exists(ABS_PATH."/uploads/blog_tag/".$result[0]['image']))
                              {
                                $floor_link1_icon='../uploads/blog_tag/'.$result[0]['image'];
                              }
          ...
          <div class="form-row">
           ...
           <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-6">
              ...
              <? $app->htmlBuilder->buildTag("select", array("class"=>"form-control ","selected"=>$sort_id, "values"=>$app->utility->sort_order('blog_tag'),"required"=>""), "sort_order") ;?>
            </div>
            <div class="form-group col-md-6">
