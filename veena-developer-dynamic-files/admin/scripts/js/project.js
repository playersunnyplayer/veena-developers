...
$(document).ready(function(){
	...
	$('#table_project').DataTable({
		...
		'ajax': {
			...
			'url':'scripts/ajax/index.php?method=project&actionType=project_list&current_status='+current_status,
...
<!-- Start:  project single delete  -->

$(document).on("click",".project_delete_onclick", function ()
...

			{
...

				{
...

					{
						  ...
						  data: "method=project&actionType=projectDelete&getid="+getid,
...
<!-- End: project single delete  -->



<!-- Start: project Multi delete  -->

function mulitple_project_select()
					...
					function (r){
						...
						if(r == true)

						  {
							  ...
							  data: "method=project&actionType=projectMultiDelete&ids="+ids,
