        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">CSR Category</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">CSR Category</h3>
        </div>
        <div class="">
          <a class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" href="index.php?view=csr_category_addedit"><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_csr_category_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      
      <?=$this->utility->get_message()?>
     <!-- <p class="mg-b-30">Sytem accept only order of below csr_category.</p>-->
      <div data-label="All CSR Category" class="df-example demo-table">
        <table id="table_csr_category" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/csr_category.js<?=ALLVERSION?>"></script> 
