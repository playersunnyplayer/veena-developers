        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Manage About Page</a></li>
              <li class="breadcrumb-item active" aria-current="page">Team</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Team</h3>
        </div>
        <div class="">
          <a class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" href="index.php?view=team_addedit"><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>
          <button class="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5" onclick="mulitple_team_select();"><i data-feather="trash" class="wd-10 mg-r-5"></i> Delete</button>
        </div>
      </div>
      
      <?=$this->utility->get_message()?>
     <!-- <p class="mg-b-30">Sytem accept only order of below team.</p>-->
...
<script src="scripts/js/team.js<?=ALLVERSION?>"></script> 
