    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        ...
        <div class="d-none d-md-block">
          <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5 projects_gallery_category_addedit_onclick" data-id=""><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</button>
         
         
        </div>
      </div>
      <!--<p class="mg-b-30">Sytem accept only order of below projects_gallery_category.</p>-->
      <div data-label="All Category" class="df-example demo-table">
        <table id="table_projects_gallery_category" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/projects_gallery_category.js<?=ALLVERSION?>"></script>
