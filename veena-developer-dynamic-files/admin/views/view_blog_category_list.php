    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Blog Category</h3>
        </div>
      ...
      <!--<p class="mg-b-30">Sytem accept only order of below blog_category.</p>-->
      <div data-label="All blog_category" class="df-example demo-table">
...
<script src="scripts/js/blog_category.js<?=ALLVERSION?>"></script>
