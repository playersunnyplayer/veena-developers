            ...
            <div>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                  <li class="breadcrumb-item"><a href="#">Mannage About Page</a></li>
              ...
              <? $this->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>$this->getGetVar('id')), "id");?>
                <? $this->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"update_data"), "act");?>
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                           ...
                           <div class="form-group col-md-4">
                            ...
                            <? $this->htmlBuilder->buildTag("input", array("class"=>"form-control ","type"=>"text"), "designation") ;?>
                          </div>
                          ...
                          <div class="form-group col-md-2">
                           ...
                           <? $this->htmlBuilder->buildTag("select", array("class"=>"form-control ", "values"=>$this->utility->sort_order('team'),"required"=>""), "sort_id") ;?>
                          </div>
                         ...
                         <?php 
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <div class="fileupload <?=$file_class?>" data-provides="fileupload">
                              ...
                              <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"> <img src="<?=$image_img;?>" class="up_img"> </div>
                              <div> 
                                <span class="btn btn-file btn-default">
                                  <span class="mg-t-5 fileupload-new btn btn-white btn-xs">Select image</span>
                              ...
                              <span class="help-block"><strong>Size :</strong> 412 x 500 px</span>
                            </div>
                          </div>
                      </div>
                  ...
                  <div class="row mg-t-15">
                    <div class="col-lg-12">
                      <button class="btn btn-primary" id="product_btn" type="submit">Submit</button> <a class="btn btn-secondary" href="index.php?view=team_list">Cancel</a> </div>
                  </div>
                  </form>
