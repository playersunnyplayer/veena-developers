  ...
  <div class="content-body">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)">Manaage Blog</a></li>
        ...
        <div class="">
          <a class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5" href="index.php?view=blog_addedit"><i data-feather="plus" class="wd-10 mg-r-5" ></i> Add New</a>
...
<script src="scripts/js/blog.js<?=ALLVERSION?>"></script> 
