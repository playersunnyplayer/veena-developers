    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h3 class="mg-b-0 tx-spacing--1">Testimonials</h3>
        </div>
        <div class="">
     ...
     <!-- <p class="mg-b-30">Sytem accept only order of below Testimonial.</p>-->
      <div data-label="All Testimonials" class="df-example demo-table">
...
<script src="scripts/js/testimonial.js<?=ALLVERSION?>"></script> 
