...
<div class="content ht-100v pd-0">
  ...
  <div class="content-body">
    <div class="container pd-x-0">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div data-label="Social Information" class="df-example demo-forms">
            <div class="row">
              <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="" for="example-email">Youtube Link </label>
                  <? $this->htmlBuilder->buildTag("input", array("type"=>"text","class"=>"form-control"), "youtube_link") ?>
                </div>
              </div>
            </div>
          </div>
