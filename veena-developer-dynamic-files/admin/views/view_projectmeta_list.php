...
<div class="content ht-100v pd-0">
  ...
  <div class="content-body">
    <div class="container">
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb df-breadcrumbs mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">projectmeta</li>
            </ol>
          </nav>
          <h3 class="mg-b-0 tx-spacing--1">Project Meta</h3>
        </div>
        <div class="">
     ...
     <!-- <p class="mg-b-30">Sytem accept only order of below projectmeta.</p>-->
      <div data-label="All CSR Category" class="df-example demo-table">
        <table id="table_projectmeta" class="table">
          <thead>
            <tr>
...
<script src="scripts/js/projectmeta.js<?=ALLVERSION?>"></script> 
