            ...
            <div>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                  <li class="breadcrumb-item"><a href="#">Mannage CSR Page</a></li>
              ...
              <? $this->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>$this->getGetVar('id')), "id");?>
                <? $this->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"update_data"), "act");?>
                      ...
                      <div data-label="Project Location" class="df-example demo-forms projectsAll OtherDivs">
                        <div class="form-row">
                          ...
                          <div class="form-group col-md-6">
                           ...
                           <? $this->htmlBuilder->buildTag("select", array("class"=>"form-control ", "values"=>$this->utility->sort_order('csr_category'),"required"=>""), "sort_id") ;?>
                          </div>
                  ...
                  <div class="row mg-t-15">
                    <div class="col-lg-12">
                      <button class="btn btn-primary" id="product_btn" type="submit">Submit</button> <a class="btn btn-secondary" href="index.php?view=csr_category_list">Cancel</a> </div>
                  </div>
                  </form>
