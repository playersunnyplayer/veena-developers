        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
              <li class="breadcrumb-item"><a href="javascript:void(0)"> Careers Page</a></li>
            ...
            $file_class="fileupload-new";
                  ...
                  <div class="fileupload <?=$file_class?>" data-provides="fileupload">
                    ...
                    <div> <span class="pl-0 btn btn-file btn-default"> <span class="mg-t-5 fileupload-new btn btn-white btn-xs">Select image</span> <span class="fileupload-exists btn btn-white btn-xs">Change</span>
                     ...
                     <span class="help-block"><strong>Size :</strong> 550 x 400 px</span>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div data-label="Job Heading" class="df-example demo-forms">
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="control-label" for="example-email">Job Section Heading</label>
