<?
	class _careers_page extends controller
	{
		function init()
		{	
		}
		...
		function onload()
		{		
			$obj_model_generel_settings = $this->app->load_model("career_detail");
		...
		{
			$obj_model_record = $this->app->load_model("career_detail");
			...
			if($update_id!=NULL)
			{
				$this->app->utility->set_message("Career Records updated successfull...", "SUCCESS");
				$this->app->redirect("index.php?view=careers_page");
			}
			else
			{
