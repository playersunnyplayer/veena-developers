      ...
      <div class="col-sm-5">
        <form class="headerForm" id="ContactForm1" name="ContactForm1" method="post">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <input type="text" class="form-control rquired" name="name" id="name" rquired placeholder="Name" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <input class="form-control rquired" name="mobile" id="mobile" rquired placeholder="Mobile No" type="text" maxlength="10" />
              </div>
            </div>
          </div>
          <div class="form-group">
            <input class="form-control rquired" name="email" id="email" rquired placeholder="Email ID" type="text" />
          </div>
          <div class="form-group">
          ...
          <div class="row">
                ...
                <div class="captchaField">
                  <div class='CaptchaWrap'>
                    <div id="CaptchaImageCode" class="CaptchaTxtField">
                      <canvas id="CapCode" class="capcode" width="180" height="50"></canvas>
                    </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <input type="text" id="UserCaptchaCode" name="UserCaptchaCode" class="form-control CaptchaTxtField rquired" rquired placeholder='Enter Captcha - Case Sensitive'>
