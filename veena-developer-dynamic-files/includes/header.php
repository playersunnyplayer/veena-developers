  ...
  <div class="topBar homeTopbar">
    <div class="container">
      ...
      else
      {
	   ...
	   if($this->gs['menu_bg_image']!='' && file_exists(ABS_PATH."/uploads/logo/".$this->gs['menu_bg_image']))
      {
      ...
      else
      {
        ...
        <figure class="logo"> <a href="index.html"> <img src="<?=$logo?>" class="img-fluid" alt="" /> </a> </figure>
        <div class="col-sm-9 topRightSec">
          <?php if($this->gs['contact_number']!=''){?>
          <div class="phoneIcon"> <a target="_blank" href="tel:<?=$this->gs['contact_number']?>"><span class="hide_767">
          ...
          <div class="hamburgerIcon desktopMenu">
            <nav>
              ...
              <label for="toggle-nav"> <span class="menu-icon"></span> </label>
